...
@Getter
public class MarkBookingConfirmedCommand {
  ...
  public MarkBookingConfirmedCommand(BookingNumber bookingNumber, FlightNumber flightNumber, PassengerName passengerName) {
